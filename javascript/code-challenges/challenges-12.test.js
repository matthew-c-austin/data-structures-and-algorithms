...
const findTagNames = elements => {
  ...
  elements.forEach(string => {
    // Since we don't want the <> characters, but we need them in the regex for ensuring nothing within the tags matches when it really shouldn't, we'll have to slice off the two characters at every match
    tagNamesArr = tagNamesArr.concat(string
      .match(regex)
